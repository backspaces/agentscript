...
function createCanvas(width = 0, height = 0, offscreen = true) {
...
const lerpScale = (number, lo, hi) => (number - lo) / (hi - lo);
...
Object.assign(util, canvas, debug, types, math, async, objects$1, oofa, dom);
